...
[
\text{spatially varying thickness}
\quad\Longrightarrow\quad
\text{spatially varying phase}
]

and therefore

[
\text{spatial phase variation}
\quad\Longrightarrow\quad
\text{wavefront curvature}
\quad\Longrightarrow\quad
\text{focusing}.
]
...
\text{Plane wave}
\rightarrow
\text{spatial phase transformation}
\rightarrow
\text{converging wavefront}
\rightarrow
\text{focus}
}
]
...
\text{Desired focus}
\rightarrow
\text{Target phase profile}
\rightarrow
\text{Meta-atom phase response}
\rightarrow
\text{Meta-atom geometry}
\rightarrow
\text{Metalens}
