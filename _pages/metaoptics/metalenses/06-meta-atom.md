...
(D,H,\text{material},\text{environment})
}
]
...
[
\mathbf E_{\mathrm{in}}(\mathbf r,t)
====================================

\mathbf E_{\mathrm{in}}(\mathbf r)
e^{-i\omega t}.
]
...
\epsilon(\mathbf r;D)
\rightarrow
\mathbf E_m(\mathbf r;D),\beta_m(D)
\rightarrow
t(D)
}
]
